...
RedactorPlugins.emoticons = {
    init: function() {
        ...
        switch (this.opts.emoticons.viewType) {
            case 'dropdown':
                ...
                if (buttonOpts.addAfter) {
                    this.addBtnAfter(buttonOpts.addAfter, 'emoticons', RLANG.emoticons, null, mylist);
                } else if (buttonOpts.addBefore) {
                    this.addBtnBefore(buttonOpts.addBefore, 'emoticons', RLANG.emoticons, null, mylist);
                } else {
                    this.addBtn('emoticons', RLANG.emoticons, null, mylist);
                }
            ...
            default:
                ...
                if (buttonOpts.addAfter) {
                    this.addBtnAfter(buttonOpts.addAfter, 'emoticons', RLANG.emoticons, callback)
                } else if (buttonOpts.addBefore) {
                    this.addBtnBefore(buttonOpts.addBefore, 'emoticons', RLANG.emoticons, callback);
                } else {
                    this.addBtn('emoticons', RLANG.emoticons, callback);
                }
        }
        ...
        if (buttonOpts.separatorAfter) {
            this.addBtnSeparatorAfter('emoticons');
        }
